...
public sealed class WunjoRuneBehavior : RuneBehavior
{
    ...
    public override void UpdatePassive(RunePassiveContext context, RuneEntity rune, float deltaTime)
    {
        ...
        var criticalHitBonusPercent = WunjoTuning.GetCriticalHitBonusPercent(rune.Stats.Tier);
        ...
        for (var i = 0; i < context.GameState.Runes.Count; i++)
        {
            ...
            targetRune.Buffs.ApplyCriticalHitBonusPercent(criticalHitBonusPercent);
        }
    }
}
